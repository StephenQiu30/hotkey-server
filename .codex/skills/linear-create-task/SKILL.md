...
Create Linear tasks with execution-ready content. Every new task should be understandable without extra chat context and strict enough to support implementation and later Agent Review.
...
- If the task changes long-lived behavior, require the matching design, contract, or documentation update.
...
- Specification impact: <design / contract / documentation updates required>
...
- Agent Review focus: <what must be checked against requirements, code, and boundaries>

## Deliverables
- <files, workflow docs, specifications, PR evidence, or linked outputs>
```
...
- Specification impact is stated when long-lived behavior changes.
