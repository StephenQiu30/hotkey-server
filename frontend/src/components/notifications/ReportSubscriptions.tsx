    ...
    <section aria-labelledby="report-subscriptions-title">
      <header className="flex flex-col gap-6 border-b border-border pb-8 sm:flex-row sm:items-end sm:justify-between">
        <div className="min-w-0">
          ...
          <h2 id="report-subscriptions-title" className="mt-3 text-2xl font-semibold tracking-[-0.04em]">报告订阅</h2>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">按监控订阅日报或周报，通过邮件或私有 RSS 获取。</p>
        </div>
