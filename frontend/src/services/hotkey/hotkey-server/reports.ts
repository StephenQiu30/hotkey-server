...
/** List reports GET /api/v1/agent/reports */
export async function getAgentReports(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: HotKeyAPI.getAgentReportsParams,
...
/** Get a report GET /api/v1/agent/reports/${param0} */
export async function getAgentReportsId(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: HotKeyAPI.getAgentReportsIdParams,
  options?: RequestOptions
) {
  const { id: param0, ...queryParams } = params;
  return request<HotKeyAPI.ReportResultHttpReportResponse>(
    `/api/v1/agent/reports/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
