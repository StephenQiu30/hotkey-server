...
/** List monitors GET /api/v1/agent/monitors */
export async function getAgentMonitors(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: HotKeyAPI.getAgentMonitorsParams,
...
/** Get a monitor GET /api/v1/agent/monitors/${param0} */
export async function getAgentMonitorsId(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: HotKeyAPI.getAgentMonitorsIdParams,
  options?: RequestOptions
) {
  const { id: param0, ...queryParams } = params;
  return request<HotKeyAPI.MonitorResultHttpMonitorResponse>(
    `/api/v1/agent/monitors/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
