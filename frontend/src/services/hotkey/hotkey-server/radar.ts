...
/** List explainable Radar events GET /api/v1/agent/radar/events */
export async function getAgentRadarEvents(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: HotKeyAPI.getAgentRadarEventsParams,
  options?: RequestOptions
) {
  return request<HotKeyAPI.EventResultHttpRadarPageResponse>(
    "/api/v1/agent/radar/events",
    {
      method: "GET",
      params: {
