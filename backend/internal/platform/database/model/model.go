...
var specs = []Spec{
	...
	{"notification_delivery_attempts", LifecycleOperational, []string{"id", "version", "user_notification_id", "channel", "delivery_target_key", "attempt_no", "status", "provider_message_id", "response_code", "error_code", "attempted_at", "created_at"}},
	{"notification_delivery_claims", LifecycleOperational, []string{"user_notification_id", "channel", "delivery_target_key", "claim_token", "claimed_at", "lease_until"}},
