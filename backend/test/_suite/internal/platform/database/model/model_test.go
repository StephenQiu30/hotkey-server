...
func TestSpecsHaveUniqueTablesAndColumns(t *testing.T) {
	...
	wantColumns := map[string][]string{
		...
		"monitor_compiled_profiles":             {"id", "version", "monitor_id", "purpose", "config_version_id", "monitor_version_id", "preview_run_id", "draft_id", "draft_resource_version", "intent_revision_id", "compiler_version", "matching_algorithm_version", "lexical_algorithm_version", "semantic_algorithm_version", "structured_algorithm_version", "search_normalization_profile_version", "semantic_state", "semantic_unavailable_reason", "status", "profile_hash", "ready_at", "retired_at", "created_at"},
		...
		"source_observation_evidences":          {"id", "source_connection_id", "source_observation_id", "evidence_snapshot_id", "locator_type", "locator_value", "selected_payload_sha256"},
		...
		"derived_artifacts":                     {"id", "source_connection_id", "document_version_id", "store_derived_rights_decision_id", "retain_rights_decision_id", "artifact_type", "transformer_profile_sha256", "vault_relative_path", "sha256", "retention_until", "lifecycle_state", "active"},
	...
	if got, want := len(seen), 98; got != want {
