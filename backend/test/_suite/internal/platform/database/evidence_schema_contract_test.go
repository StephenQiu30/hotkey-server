...
func TestEvidenceSchemaSeparatesRawObservationDocumentAndProjectionFacts(t *testing.T) {
	...
	for _, table := range []string{
		...
		"document_versions", "derived_artifacts", "derived_artifact_deletion_audits", "document_anchor_blocks",
	} {
	...
	for name, snippet := range map[string]string{
		...
		"derived deletion append-only audit": "create trigger derived_artifact_deletion_audits_append_only",
