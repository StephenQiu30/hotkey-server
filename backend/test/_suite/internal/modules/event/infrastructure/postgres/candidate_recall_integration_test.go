...
) VALUES ('default','content.embedding.v1','embedding',$1,$2,1,'structured-provider-v1',$3,'fixture','v1',$4,'succeeded',$5,'event-recall-v1','fixture','v1',repeat('c',64),$6,1,1,current_date,1)
