...
func transportCitationDTO(documentVersionID int64, artifactSHA string) ingestionapplication.CitationDTO {
	...
	return ingestionapplication.CitationDTO{
		...
		ContentOriginAvailability:      ingestionapplication.CitationFactUnavailable,
		ContentOriginUnavailableReason: ingestionapplication.CitationReasonContentOriginUnavailable,
