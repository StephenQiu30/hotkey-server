...
func TestMonitorAndSourceCodesAreRegisteredWithStableHTTPStatus(t *testing.T) {
	...
	tests := []struct {
		...
		{CodeMonitorIntentDraftUninitialized, stdhttp.StatusNotFound},
		{CodeMonitorIntentVersionConflict, stdhttp.StatusConflict},
		{CodeMonitorIntentIdempotencyConflict, stdhttp.StatusConflict},
		{CodeMonitorIntentRunNotFound, stdhttp.StatusNotFound},
