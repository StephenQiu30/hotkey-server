...
func Test001PartialAcceptanceRecordsVerifiedBaselineAndHonestGaps(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"EV-001-024",
		"EV-001-025",
		"https://github.com/StephenQiu30/hotkey-server/actions/runs/33248525810",
		"3d9acccbc136195ee1c26fa7d9cec69cef2d1740",
		"contents-keyset-capacity-macos-arm64-3d9acccb.json",
		"joint-recovery-macos-arm64-3d9acccb.json",
		...
		"TestModelProfileRoutesEnforceAdminControlPlaneAndRedactCredentials",
		"TestRetentionPolicyValidationAllowsOnlyFixedSevenDataClasses",
		"TestRetentionPolicySchemaRejectsAnEighthDataClass",
		"TestRetentionPoliciesAreAFixedSevenItemReferenceCatalog",
		"TestCatalogHasFixedTwelveItemMaximumAndKeepsConnectionDetailsServerSide",
		"TestSourcePresetCatalogIsServedByTheBackend",
		"ai_model_profile_list",
		"https://github.com/StephenQiu30/hotkey-server/actions/runs/33235504594",
		"TestMonitorScanCursorIsSignedResourceBoundExpiringAndSnapshotStable",
		"TestMonitorConfigHistoryCursorIsSignedViewBoundExpiringAndSnapshotStable",
		"monitor_scan_list",
		"monitor_config_history",
		"https://github.com/StephenQiu30/hotkey-server/actions/runs/33234032155",
		"TestKnowledgeListCursorsAreSignedBoundExpiringAndSnapshotStable",
		"TestKnowledgeListRoutesForwardOpaqueCursorsAndRejectInvalidQueries",
		"knowledge_document_list",
		"knowledge_proposal_list",
		"https://github.com/StephenQiu30/hotkey-server/actions/runs/33232453453",
		"TestUserRepositoryListCursorIsSignedFilterBoundExpiringAndSnapshotStable",
		"TestListUsersPassesPaginationAndFiltersAndReturnsSafePage",
		"TestListUsersRejectsInvalidQueryBeforeService",
		"TestListUsersMapsInvalidCursorToStableValidationError",
		"identity_user_list",
		"https://github.com/StephenQiu30/hotkey-server/actions/runs/33230114986",
		...
		"TestCollectionRunListCursorIsSignedExpiringAndSnapshotStableAcrossConcurrentInsert",
		"collection_run_list",
		"TestCapturedItemListCursorIsSignedBoundExpiringAndSnapshotStableAcrossConcurrentInsert",
		"captured_item_list",
		"TestRelevanceMatchListCursorKeepsFirstPageHighWaterAcrossConcurrentInsert",
		"TestRelevanceCursorsRejectTamperingAndCrossQueryReuse",
		"relevance_match_list",
		"TestRelevanceSuggestionListCursorUsesImmutableOrderAcrossConcurrentUpdate",
		"relevance_suggestion_list",
		"TestDocumentMatchListCursorIsSignedBoundExpiringAndStableAcrossConcurrentInsert",
		"document_match_decision_id",
		"TestRightsManagementProjectionListCursorsAreSignedBoundExpiringAndStable",
		"Rights Policy/Decision Batch",
		"TestMicroEventQueryRepositoryAppliesMultiDimensionalFiltersAndStableRelevanceCursor",
		"TestMicroEventListCursorFreezesRankingAndRejectsChangedQuery",
		"micro_event_list",
