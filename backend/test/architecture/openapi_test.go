...
func TestOpenAPIContract(t *testing.T) {
	...
	required := map[string]map[string][]string{
		...
		"/api/v1/operations/retention-policies/{id}/preview":                       {"post": {"200", "400", "401", "403", "404", "409", "503"}},
		"/api/v1/operations/retention-runs/{id}":                                   {"get": {"200", "400", "401", "403", "404", "503"}},
		"/api/v1/operations/retention-runs/{id}/approve":                           {"post": {"200", "400", "401", "403", "404", "409", "503"}},
		"/api/v1/operations/retention-runs/{id}/execute":                           {"post": {"200", "400", "401", "403", "404", "409", "503"}},
		...
		"/api/v1/notifications/read-receipts":                                      {"post": {"200", "400", "401", "404", "409", "503"}},
		"/api/v1/notifications/ws":                                                 {"get": {"101", "400", "503"}},
		"/api/v1/reports":                                                          {"get": {"200", "400", "401", "503"}, "post": {"200", "400", "401", "403", "409"}},
		...
		"/api/v1/reports/{id}/submit":                                              {"post": {"200", "400", "401", "403", "409"}},
		"/api/v1/reports/{id}/approve":                                             {"post": {"200", "400", "401", "403", "409"}},
		"/api/v1/reports/{id}/reject":                                              {"post": {"200", "400", "401", "403", "409"}},
		"/api/v1/knowledge/documents":                                              {"get": {"200", "401", "403"}},
		"/api/v1/knowledge/documents/{id}":                                         {"get": {"200", "401", "403", "404"}},
		"/api/v1/knowledge/proposals":                                              {"get": {"200", "401", "403"}, "post": {"200", "400", "401", "403", "409"}},
		"/api/v1/knowledge/proposals/{id}":                                         {"get": {"200", "401", "403", "404"}},
