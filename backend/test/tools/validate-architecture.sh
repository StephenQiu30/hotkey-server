...
for path in db/schema db/migrations internal/common internal/controller internal/dao internal/mapper internal/model internal/pojo internal/repository internal/service internal/utils internal/queue internal/worker internal/fxapp; do
