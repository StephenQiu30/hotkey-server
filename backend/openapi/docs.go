...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.ContentResult-http_HotspotPageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/micro-events": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "opaque frozen-ranking cursor",
                        "name": "cursor",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "minimum": 1,
                        "type": "integer",
                        "description": "monitor relevance filter",
                        "name": "monitor_id",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "comma-separated evidence states",
                        "name": "evidence_state",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "event start lower bound in RFC3339",
                        "name": "started_from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "event start upper bound in RFC3339",
                        "name": "started_to",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/monitors/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "simple monitor update",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.UpdateMonitorRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.CollectionResult-http_MonitorScanPageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/operations/retention-runs/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "comma-separated content,event,knowledge",
                        "name": "types",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "maxLength": 128,
                        "type": "string",
                        "description": "exact normalized entity",
                        "name": "entity",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "relevance or latest",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "inclusive RFC3339 start",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "inclusive RFC3339 end",
                        "name": "to",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.SearchResult-http_SearchPageResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/http.SearchResult-http_SearchEmptyResponseDTO"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.InstantSearchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.SourceResult-http_InstantSearchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "hotspot.HotspotCardResponse": {
            ...
            "properties": {
                ...
                "metrics": {
                    "$ref": "#/definitions/hotspot.MetricsResponse"
                },
                "published_at": {
                    "type": "string",
                    "x-nullable": true
        ...
        "http.CollectionResult-http_MonitorScanPageResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/http.MonitorScanPageResponse"
                },
                "message": {
                    "type": "string"
                }
        ...
        "http.ContentResult-http_HotspotPageResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/http.HotspotPageResponse"
                },
                "message": {
                    "type": "string"
                }
        ...
        "http.HotspotPageResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/hotspot.HotspotCardResponse"
                    }
                },
                "next_cursor": {
                    "type": "string"
        ...
        "http.InstantSearchResponse": {
            ...
            "properties": {
                ...
                "source_statuses": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.InstantSearchSourceStatusResponse"
                    }
                }
            }
        },
        "http.InstantSearchSourceStatusResponse": {
            "type": "object",
            "properties": {
                "error_code": {
                    "type": "string"
        ...
        "http.MonitorScanResponse": {
            ...
            "properties": {
                ...
                "sources": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.MonitorScanSourceResponse"
                    }
                },
                "started_at": {
                    "type": "string"
        ...
        "http.MonitorScanSourceResponse": {
            "type": "object",
            "properties": {
                "accepted_count": {
                    "type": "integer"
        ...
        "http.SearchEmptyResponseDTO": {
            "type": "object"
        },
        "http.SearchItemResponseDTO": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "http.SearchPageResponseDTO": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.SearchItemResponseDTO"
                    }
                },
                "next_cursor": {
                    "type": "string"
        ...
        "http.SearchResult-http_SearchEmptyResponseDTO": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/http.SearchEmptyResponseDTO"
                },
                "message": {
                    "type": "string"
                }
        ...
        "http.SearchResult-http_SearchPageResponseDTO": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/http.SearchPageResponseDTO"
                },
                "message": {
                    "type": "string"
                }
        ...
        "http.SourceConfigDTO": {
            ...
            "properties": {
                ...
                "x_metric_refresh_daily_request_budget": {
                    "type": "integer"
                },
                "x_metric_refresh_enabled": {
                    "type": "boolean"
                },
                "x_metric_refresh_interval_minutes": {
                    "type": "integer"
                },
                "x_metric_refresh_max_posts_per_run": {
                    "type": "integer"
                },
                "x_metric_refresh_observation_hours": {
                    "type": "integer"
                }
            }
        },
        ...
        "http.SourceResult-http_InstantSearchResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/http.InstantSearchResponse"
                },
                "message": {
                    "type": "string"
                }
