...
- [ ] Slice-010-1：实现「X 来源配置与健康检查」，补齐实际涉及的领域、任务、API 与界面，并绑定 AC-010-* 回归。
- [ ] Slice-010-2：实现「关键词和账号查询」，补齐实际涉及的领域、任务、API 与界面，并绑定 AC-010-* 回归。
- [ ] Slice-010-3：实现「分页检查点与指标快照」，补齐实际涉及的领域、任务、API 与界面，并绑定 AC-010-* 回归。
- [ ] Slice-010-4：实现「授权、配额和删除/隐藏同步」，补齐实际涉及的领域、任务、API 与界面，并绑定 AC-010-* 回归。
