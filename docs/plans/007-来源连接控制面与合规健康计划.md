...
- [ ] Slice-007-1：实现「来源目录和配置表单」，补齐实际涉及的领域、任务、API 与界面，并绑定 AC-007-* 回归。
- [ ] Slice-007-2：实现「连接健康检测与诊断」，补齐实际涉及的领域、任务、API 与界面，并绑定 AC-007-* 回归。
- [ ] Slice-007-3：实现「能力档案、配额和指标映射」，补齐实际涉及的领域、任务、API 与界面，并绑定 AC-007-* 回归。
- [ ] Slice-007-4：实现「凭据引用与条款审计」，补齐实际涉及的领域、任务、API 与界面，并绑定 AC-007-* 回归。
