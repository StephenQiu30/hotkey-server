...
| 019 | [采集内容 Markdown 归档与预览](../prd/019-采集内容Markdown归档与预览.md) | [执行计划](019-采集内容Markdown归档与预览计划.md) | 006, 007, 017 | done | approved |

PLAN-001–018 已移入 [`archive/`](archive/README.md)，并保留对应验收证据。PLAN-019 已完成全量门禁和独立实现复审。017–019 的外部依赖演练以 `accepted_with_risk` 记录，不把部署环境尚未执行的备份/SMTP/MinIO/DeepSeek/Ollama 结果写成已通过。
