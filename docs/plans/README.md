...
PLAN-008 已由 Acceptance-008 独立验收并归档为 `done/approved`；PLAN-009 已通过独立开工审核，Task 1–6 自动门禁已验证，其中 Task 3 已获独立复核；独立最终复核仍待完成，故保持 `in_progress/approved`，010–017 仍为 `backlog/pending`，不得自动开工。
