...
| 012 | [证据化事件摘要实体与主张](../prd/012-证据化事件摘要实体与主张.md) | [执行计划](012-证据化事件摘要实体与主张计划.md) | 008, 010 | done | approved |
...
PLAN-008–012 已归档为 `done/approved`。PLAN-012 的证据化事件智能已通过离线评测与完整质量门禁；长期采集/编排质量由 PLAN-013/017 验收。PLAN-013–017 保持 `backlog`，不能标记为正在实施或 done。
