...
|---|---|---|---|---|---|
| 001 | [模块化单体、Schema基线与工程门禁](../prd/001-模块化单体启动与工程门禁计划.md) | [执行计划](001-模块化单体启动与工程门禁计划.md) | 无 | in_progress | approved |
| 002 | [数据库运行时、事务与兼容性平台](../prd/002-单一Schema与数据库平台.md) | [执行计划](002-单一Schema与数据库平台计划.md) | 001 | backlog | pending |
