...
PLAN-008/009/010 已归档为 `done/approved`。PLAN-010 的事件生命周期、治理事务和 API 已通过事件/数据库集成、全量门禁与独立复审；长期采集/编排质量由 PLAN-013/017 验收。011–017 虽已有部分核心契约，但尚未通过各自的 Plan Review 和依赖准入，必须保持 `backlog`，不能标记为正在实施或 done。
