...
| 009 | [多语言相关性匹配与反馈](../prd/009-多语言相关性匹配与反馈.md) | [执行计划](009-多语言相关性匹配与反馈计划.md) | 005, 007, 008 | ready | approved |
...
PLAN-008 已由 Acceptance-008 独立验收并归档为 `done/approved`；PLAN-009 已独立复核为 `ready/approved`，可按其 Task 1 开工；010–017 仍为 `backlog/pending`，不得自动开工。
