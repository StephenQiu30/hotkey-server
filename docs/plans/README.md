...
| 011 | [热度趋势与监控排序](../prd/011-热度趋势与监控排序.md) | [执行计划](011-热度趋势与监控排序计划.md) | 010 | ready | approved |
...
PLAN-008/009/010 已归档为 `done/approved`。PLAN-011 已完成独立准入复审并进入 `ready/approved`，用于实现同步热度重算；长期采集/编排质量由 PLAN-013/017 验收。PLAN-012–017 尚未通过各自的 Plan Review 和依赖准入，必须保持 `backlog`，不能标记为正在实施或 done。
