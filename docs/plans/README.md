...
| 025 | [事件变化雷达与低噪声告警](../prd/025-事件变化雷达与低噪声告警.md) | [执行计划](025-事件变化雷达与低噪声告警计划.md) | 010–013 | ready | approved |

PLAN-001–024 已移入 [`archive/`](archive/README.md)，并保留对应验收证据。PLAN-025 已通过独立 readiness 复审并进入实施。
