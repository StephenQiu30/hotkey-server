...
PLAN-008–011 已归档为 `done/approved`。PLAN-011 已完成同步热度重算、版本化快照与排序验收；长期采集/编排质量由 PLAN-013/017 验收。PLAN-012–017 尚未通过各自的 Plan Review 和依赖准入，必须保持 `backlog`，不能标记为正在实施或 done。
