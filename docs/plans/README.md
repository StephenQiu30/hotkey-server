...
| 010 | [事件聚类生命周期与人工治理](../prd/010-事件聚类生命周期与人工治理.md) | [执行计划](010-事件聚类生命周期与人工治理计划.md) | 009 | done | approved |
| 011 | [热度趋势与监控排序](../prd/011-热度趋势与监控排序.md) | [执行计划](011-热度趋势与监控排序计划.md) | 010 | done | approved |
| 012 | [证据化事件摘要实体与主张](../prd/012-证据化事件摘要实体与主张.md) | [执行计划](012-证据化事件摘要实体与主张计划.md) | 008, 010 | in_progress | approved |
...
PLAN-008–011 已归档为 `done/approved`。PLAN-012 已按用户执行指令进入证据化事件智能实施；长期采集/编排质量由 PLAN-013/017 验收。PLAN-013–017 保持 `backlog`，不能标记为正在实施或 done。
