...
| 009 | [多语言相关性匹配与反馈](../prd/009-多语言相关性匹配与反馈.md) | [执行计划](009-多语言相关性匹配与反馈计划.md) | 005, 007, 008 | in_progress | approved |
...
PLAN-008 已由 Acceptance-008 独立验收并归档为 `done/approved`；PLAN-009 的 Task 1–6、两项 P1 整改和 `d4efda5` relevance-review 序列化修复已通过完整门禁。独立最终复审仍待完成，故保持 `in_progress/approved`，010–017 仍为 `backlog/pending`，不得自动开工。
