...
| 008 | [AIProvider与Embedding基础](../prd/008-AIProvider与Embedding基础.md) | [执行计划](008-AIProvider与Embedding基础计划.md) | 002, 007 | in_progress | approved |
...
PLAN-008 已通过独立 Plan Review 并正在实现；009–017 仍为 `backlog/pending`，不得自动开工。
