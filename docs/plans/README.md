...
| 008 | [AIProvider与Embedding基础](../prd/008-AIProvider与Embedding基础.md) | [执行计划](008-AIProvider与Embedding基础计划.md) | 002, 007 | ready | approved |
...
PLAN-008 已通过独立 Plan Review 并处于 `accepted/approved/ready`，是当前唯一可开工的产品计划；009–017 仍为 `backlog/pending`，不得自动开工。
