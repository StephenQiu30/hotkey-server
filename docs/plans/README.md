...
| 006 | [社交媒体关键词监控与评论分析](../design/006-社交媒体关键词监控与评论分析设计.md) | [PRD](../prd/006-社交媒体关键词监控与评论分析.md) | [Plan](006-社交媒体关键词监控与评论分析计划.md) | 新增独立切片 | planned |

006 尚未实施，不属于下方既有 24 周完成声明。它按用户要求比较并允许替换旧架构，v2 推荐全 Python 服务端、任务账本/Outbox 与 Alembic 新库，身份权限独立重建，评论 P0；上方旧架构执行基线在 006 切片进入实施时同步更新。
