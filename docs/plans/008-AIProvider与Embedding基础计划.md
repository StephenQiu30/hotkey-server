...
- Modify: `internal/bootstrap/{app,app_test}.go`, `internal/modules/intelligence/{application/model_profile_service.go,domain/profile.go,infrastructure/postgres/{repository,model_profile_repository,model_profile_repository_test}.go}`, `tests/architecture/openapi_test.go`, `docs/openapi/swagger.json`
