...
重新立项基线目前没有整体 `passed` 的 Acceptance。001–005 均已建立 `failed` 的部分验收，只登记证据完整的局部门禁并保留整体未完成结论；旧验收文件属于被清理的历史基线，不得用来证明 001–005 的新需求已经实现。
...
| 004 | 通知报告知识投影与检索 | in_progress | [部分验收](004-通知报告知识投影与检索验收.md)（`failed`） |
