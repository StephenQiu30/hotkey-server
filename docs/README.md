...
| 003 | 智能研判、事件、热度与治理 | [Design](design/003-智能研判事件热度与人工治理设计.md) | [PRD](prd/003-智能研判事件热度与人工治理.md) | [Plan](plans/003-智能研判事件热度与人工治理计划.md) | G3 已通过，执行中 |
| 004 | 通知、报告、知识与检索 | [Design](design/004-通知报告知识投影与检索设计.md) | [PRD](prd/004-通知报告知识投影与检索.md) | [Plan](plans/004-通知报告知识投影与检索计划.md) | G3 已通过，执行中 |
| 005 | 安全、运维、质量与交付 | [Design](design/005-安全运维质量与交付设计.md) | [PRD](prd/005-安全运维质量与交付.md) | [Plan](plans/005-安全运维质量与交付计划.md) | G3 已通过，执行中 |
...
当前 001–005 Design 均为 `accepted`、PRD 均为 `approved`、Plan 均为 `in_progress`，表示五个交付域已获授权按门禁实施。已获授权不等于已经完成；任何现有代码或已勾选的局部门禁都不能冒充同编号 Acceptance 已通过。
