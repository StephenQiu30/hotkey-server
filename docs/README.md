...
统一异常、响应和状态契约由 [046 Design](design/046-全局异常与响应契约设计.md) 定义；[046 Plan](plans/046-全局异常与响应契约前置计划.md) S03 是所有其他实施的共同前置。当前仅完成设计/编排，未通过运行验收；研究和设计准备可先开展。
...
| 046 | 全局异常与响应契约前置 | 当前代码与隔离探针核对见 Design | 承接既有质量需求，不新增产品 PRD | [统一设计](design/046-全局异常与响应契约设计.md) · proposed | [前置计划](plans/046-全局异常与响应契约前置计划.md) · planned；Acceptance 未建立 |
...
046 为公共技术前置：[Design](design/046-全局异常与响应契约设计.md) · proposed；[Plan](plans/046-全局异常与响应契约前置计划.md) · planned；Acceptance 未建立。不新增产品 PRD，不改变 43 项需求及优先级分母。
