...
> **已被 035 替代（2026-08-12）**：用户明确首版不是 X-only，而是 7+ 来源聚合的 AI 热点监控工具。本文件中“非 X 来源退出”“只创建/调度 X”等决策无效，不得继续实施。仍有效的单一 MicroEvent ID、停止 legacy 双写和移除报告/知识库等重复产品面的决定已纳入 [035 多源 AI 热点监控首版收敛设计](035-多源AI热点监控首版收敛设计.md)。
