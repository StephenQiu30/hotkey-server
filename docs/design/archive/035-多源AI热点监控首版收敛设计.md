...
version: v1.2
owner: HotKey Team
canonical_path: docs/design/archive/035-多源AI热点监控首版收敛设计.md
...
superseded_by: docs/design/archive/037-实时热点监控MVP功能基线设计.md
---
...
本 Design 曾经用户 2026-08-12 确认并完成对应实现，其验收记录仍是历史事实。用户于 2026-08-13 将 MVP 重新收敛为参考项目已支持的热点监控闭环后，本 Design 的复杂产品边界由 [037 实时热点监控 MVP 功能基线](037-实时热点监控MVP功能基线设计.md) 替代，状态改为 `superseded`。
