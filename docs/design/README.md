...
| [`018-采集批次与队列任务原子重试设计.md`](018-采集批次与队列任务原子重试设计.md) | failed/cancelled 采集批次与原 River 任务的事务一致重试 | accepted |

001–017 的现有设计均已随对应实施与长期验收证据归档；018 为当前实施设计。已落地设计见 [`archive/`](archive/README.md)。
