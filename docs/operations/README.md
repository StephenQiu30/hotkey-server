...
| 文档 | 说明 | 状态 |
|---|---|---|
| [001-本地与GitHub CI质量门禁](001-本地与GitHub%20CI质量门禁.md) | `make ci` 的本地复现、GitHub Actions 流程及测试依赖边界 | accepted |
| [PLAN007现有库受控升级](plan007-schema-upgrade.md) | PLAN-006 既有数据的备份、回填、legacy-zero、验证与回退 | accepted |
