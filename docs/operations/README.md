...
| [PLAN009 Schema 升级](plan009-schema-upgrade.md) | relevance_review、相关性快照/反馈/建议及有界召回索引、固定 PLAN-008 历史库演练与回退 | in_progress | Task 1–5 已验证，其中 Task 3 已获独立复核，PLAN-009 最终验收待 Task 6 |
