...
| [PLAN009 Schema 升级](plan009-schema-upgrade.md) | relevance_review、相关性快照/反馈/建议及有界召回索引、固定 PLAN-008 历史库演练与回退 | in_progress | Task 1–3 已验证并获独立复核，PLAN-009 整体验收待后续任务 |
