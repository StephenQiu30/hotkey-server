...
| [PLAN009 Schema 升级](plan009-schema-upgrade.md) | relevance_review、相关性快照/反馈/建议及有界召回索引、固定 PLAN-008 历史库演练与回退 | in_progress | `d4efda5` 完整门禁与 P1 整改已验证；PLAN-009 独立复审仍待完成 |
