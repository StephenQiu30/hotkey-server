...
| [009](009-多语言相关性匹配与反馈.md) | 多语言相关性匹配与反馈 | P0 | P0 | 005, 007, 008 | accepted | ready |
...
PLAN-008 已由 Acceptance-008 独立验收并归档为 `archived/done`；PLAN-009 已独立复核为 `accepted/ready`，可按其 Task 1 开工；010–017 仍为 `review/backlog`，不得自动开工。
