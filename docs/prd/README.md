...
| [011](011-热度趋势与监控排序.md) | 热度、趋势与监控排序 | P0 | P0 | 010 | accepted | in_progress |
...
PLAN-008/009/010 已归档为 `archived/done`。PLAN-011 已完成独立准入复审并开始实施同步热度重算；实际采集到长期线上质量的编排由 PLAN-013/017 验收。PLAN-012–017 尚未通过各自的 Plan Review 和依赖准入，保持 `backlog`，不得描述为正在实施。
