...
| [012](012-证据化事件摘要实体与主张.md) | 证据化事件摘要、实体与主张 | P0 | P0 | 008, 010 | accepted | done |
...
PLAN-008–012 已归档为 `archived/done`。PLAN-012 的事件智能闭环已通过离线评测与完整质量门禁；实际采集到长期线上质量的编排由 PLAN-013/017 验收。PLAN-013–017 保持 `backlog`，不得描述为正在实施。
