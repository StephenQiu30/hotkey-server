...
| [023](023-首管理员数据库指定.md) | 首管理员数据库指定与引导凭据移除 | Closure | P1 | 004, 020 | accepted | ready |
...
PRD-001–022 已移入 [`archive/`](archive/README.md)。PRD-023 等待独立 Plan Review；外部依赖和隔离测试环境限制按对应 Acceptance/Operations 记录。
