...
PLAN-008 已由 Acceptance-008 独立验收并归档为 `archived/done`；PLAN-009 已通过开工审核，Task 1–2 已验证并获独立复核，下一步是 Task 3（`accepted/in_progress`）；010–017 仍为 `review/backlog`，不得自动开工。
