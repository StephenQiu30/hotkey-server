...
| [010](010-事件聚类生命周期与人工治理.md) | 事件聚类、生命周期与人工治理 | P0 | P0 | 009 | review | in_progress |
...
PLAN-008/009 已归档为 `archived/done`。PLAN-010 的 canonical 合并版本契约已修订，正在等待独立复审后才能继续实施；011–017 虽已有部分核心代码契约，但尚未通过各自的 Plan Review 和依赖准入，因此保持 `backlog`，不得描述为正在实施。
