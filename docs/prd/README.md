...
|---|---|---|---|---|---|---|
| [001](001-模块化单体启动与工程门禁.md) | 模块化单体启动与工程门禁 | F0 | P0 | 无 | review | backlog |
| [002](002-单一Schema与数据库平台.md) | 单一 Schema 与数据库平台 | F0 | P0 | 001 | review | backlog |
| [003](003-HTTP契约安全与可观测基础.md) | HTTP 契约、安全与可观测基础 | F0 | P0 | 001, 002 | review | backlog |
