...
本目录把 docs/design/001–012 的目标设计转换为可排期、可实现、可测试、可验收的后端任务。设计文档回答“系统应当是什么”，PRD 回答“下一项实现交付什么、依赖什么、如何证明完成”。
...
|---|---|---|---|---|---|---|
| [001](001-模块化单体启动与工程门禁.md) | 模块化单体、Schema基线与工程门禁 | F0 | P0 | 无 | accepted | in_progress |
| [002](002-单一Schema与数据库平台.md) | 数据库运行时、事务与兼容性平台 | F0 | P0 | 001 | accepted | backlog |
| [003](003-HTTP契约安全与可观测基础.md) | HTTP 契约、安全与可观测基础 | F0 | P0 | 001, 002 | accepted | backlog |
| [004](004-身份认证会话与权限.md) | 身份、认证、会话与权限 | F0 | P0 | 002, 003 | review | backlog |
