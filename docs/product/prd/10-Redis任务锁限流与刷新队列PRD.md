...
purpose: "使用 Redis 支撑任务锁、限流、热点缓存、刷新队列和短期去重。"
canonical_path: "docs/product/prd/10-Redis任务锁限流与刷新队列PRD.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
...
- 围绕 `Redis任务锁限流与刷新队列` 定义后端能力、数据边界、API 影响和验收口径。
