...
purpose: "建立 Go 模块化单体基础工程、PostgreSQL、pgvector、Redis 配置和 OpenAPI 导出。"
canonical_path: "docs/product/prd/2-Go服务基础工程与OpenAPIPRD.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
...
outputs:
  - Go服务基础工程与OpenAPI需求边界
  - Go服务基础工程与OpenAPI验收标准
triggers:
  - "Go服务基础工程与OpenAPI范围变更"
  - "对应 issue 拆分或合并"
downstream:
  - docs/plans/2-Go服务基础工程与OpenAPI实现计划.md
---

# 2-Go服务基础工程与OpenAPI PRD
...
- 围绕 `Go服务基础工程与OpenAPI` 定义后端能力、数据边界、API 影响和验收口径。
