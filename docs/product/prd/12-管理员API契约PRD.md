...
purpose: "定义管理员后台 API，覆盖关键词、来源、任务、事件审查和日报生成。"
canonical_path: "docs/product/prd/12-管理员API契约PRD.md"
status: approved
version: "1.0.0"
owner: "StephenQiu30"
inputs:
...
- 围绕 `管理员API契约` 定义后端能力、数据边界、API 影响和验收口径。
