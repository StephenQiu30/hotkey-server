...
(
  ...
  HOTKEY_TEST_DSN="$dsn" go run ./test/runner test ./internal/platform/database ./internal/shared/repository -count=1
  ...
  HOTKEY_TEST_DSN="$capacity_dsn" sh test/tools/generate-capacity-fixture.sh
)
