...
func TestSpecsHaveUniqueTablesAndColumns(t *testing.T) {
	...
	wantColumns := map[string][]string{
		...
		"content_embeddings":          {"id", "content_id", "model_profile_id", "model_profile_version", "model_version", "input_hash", "embedding", "active"},
		"monitor_embeddings":          {"id", "monitor_id", "model_profile_id", "model_profile_version", "model_version", "input_hash", "query_text", "embedding", "active"},
		"event_embeddings":            {"id", "event_id", "model_profile_id", "model_profile_version", "model_version", "input_hash", "embedding", "active"},
		"topic_embeddings":            {"id", "topic_id", "model_profile_id", "model_profile_version", "model_version", "input_hash", "embedding", "active"},
	...
	if got, want := len(seen), 53; got != want {
