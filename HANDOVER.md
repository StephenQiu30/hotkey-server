...
047 S04/008 评论所需的 [010 增量与历史回补 Design](docs/design/010-增量更新与历史回补设计.md) 已接受来源无关的内部契约，Plan 进入 in_progress，S00 G0—G2 已关闭：核对 046/007/009/031/036/037 前置、现有本机服务和显式 UTC 分页样本，冻结 jobs 单一范围状态、连续确认与 content/Job 分责。S01 尚无代码；无真实多页来源样本，不设置通用 10 分钟重叠或旧帖刷新周期，不证明平台覆盖。产品 0/6 AC、Acceptance 均未变化。
