...
## 本地网页与浏览器采集 S01 / S02 / S03-T00/T01
...
1. 047 S02 网页业务闭环及 S03-T00/T01 浏览器基础已完成：固定 Playwright Python/Server 1.63.0 原生 WS，browser 默认断网且非 root/sandbox，暂不引入 Scrapling/Selector/CDP。下一步严格进入 S03-T02，验证动态动作、独立 context、会话状态及取消/换版；平台出站仍须独立安全门禁。不得把内部无网络探针当作四平台评论或产品 Acceptance，产品 AC 仍为 0/8。
