...
func TestUpsertMonitorHitCreatesHit(t *testing.T) {
	repo := &fakecontent.HitRepo{}
	err := repo.UpsertHit(context.Background(), content.MonitorHit{
		MonitorID:       1,
		PostID:          2,
...
func TestUpsertMonitorHitDeduplicates(t *testing.T) {
	repo := &fakecontent.HitRepo{}
	hit := content.MonitorHit{MonitorID: 1, PostID: 2, RelevanceScore: 0.8}
...
func TestUpsertMonitorHitMultipleMonitors(t *testing.T) {
	...
	_ = repo.UpsertHit(context.Background(), content.MonitorHit{MonitorID: 1, PostID: 2})
	_ = repo.UpsertHit(context.Background(), content.MonitorHit{MonitorID: 2, PostID: 2})
